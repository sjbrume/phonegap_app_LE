export const lexicon = {
    'RU':{
        ...
        message: 'Суть жалобы',
        default_message: {
            not_issued_a_check: 'Не выдали чек',
            no_license: 'Отсутствует оицензия ',
            sale_without_excise_stamps: 'Реализация без акцизных марок',
            sale_to_minors: 'Продажа алкоголя или сигарет несовершеннолетним',
            other: 'Другое',
        },
        photo: 'Добавить фото',
        phone: 'Телефон',
